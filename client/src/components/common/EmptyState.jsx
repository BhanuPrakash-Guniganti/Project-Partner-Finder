...
const EmptyState = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center bg-gray-900/30 border border-gray-800/80 rounded-3xl space-y-4 my-4 max-w-lg mx-auto w-full">
      {useBrandIcon ? (
        <AppIcon size="lg" className="shadow-lg shadow-cyan-500/20" />
      ) : (
