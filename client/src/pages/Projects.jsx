...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-gray-100 flex flex-col justify-between w-full max-w-full overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 sm:py-6 pb-36 sm:pb-24 md:pb-10 pb-[calc(8rem+env(safe-area-inset-bottom))] w-full space-y-6 flex-1 min-w-0">
